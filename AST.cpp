...
// 	//"hello"
// 	A_exp hello	= A_StringExp(Position::undefined(), "hello\n");

// 	//6 * ("hello"; 3+4)
// 	A_exp hw2a5 = A_OpExp(undef, A_timesOp, A_IntExp(undef,6), 
// 	A_SeqExp(undef, 
// 		A_ExpList(hello, 
// 				A_ExpList(A_IntExp(undef, 7),0))));
...
A_compExp_::A_compExp_(A_pos pos, A_oper oper, A_exp left, A_exp right) :  A_exp_(pos), _oper(oper), _left(left), _right(right)
{
	precondition(left != 0 && right != 0);
}
